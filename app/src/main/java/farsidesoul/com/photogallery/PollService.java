...
public class PollService extends IntentService {
    ...
    private static final int POLL_INTERVAL = 1000 * 60; // 5 Minutes
    public static final String PREF_ALARM_IS_ON = "isAlarmOn";

    public static final String ACTION_SHOW_NOTIFICATION =
            "com.farsidesoul.android.photogallery.SHOW_NOTIFICATION";
    ...
    public static void setServiceAlarm(Context context, boolean isOn){
        ...
        PreferenceManager.getDefaultSharedPreferences(context)
                .edit()
                .putBoolean(PollService.PREF_ALARM_IS_ON, isOn)
                .apply();
    }
